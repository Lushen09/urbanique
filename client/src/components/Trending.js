...
const Trending = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            const response1 = await fetch('https://urbanique.vercel.app/api/products/category/jewelery');
            const response2 = await fetch(`https://urbanique.vercel.app/api/products/category/men's clothing`);
